...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create ama-bb20
  fly apps create ama-bb20-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app ama-bb20
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app ama-bb20-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'ama-bb20-staging' does not match app name in config file 'ama-bb20'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name ama-bb20-db
  fly postgres attach --app ama-bb20 ama-bb20-db

  fly postgres create --name ama-bb20-staging-db
  fly postgres attach --app ama-bb20-staging ama-bb20-staging-db
  ```
